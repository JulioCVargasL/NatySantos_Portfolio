...
SECRET_KEY = 'django-insecure-ezf82hnsz&ly3!rd!-ft*ww%1#_)fd==k$0ngivi@n$5ha(aj_'
...
ROOT_URLCONF = 'portfolio_NatySantos.urls'
...
WSGI_APPLICATION = 'portfolio_NatySantos.wsgi.application'
...
# Creado para cargar los statics
